...
import 'package:pick_my_parcel_customer/screens/track_individual_courier_screen.dart';
import 'package:pick_my_parcel_customer/screens/view_individual_order_screen.dart';
      ...
      childWidget: Column(children: [
        ...
        Padding(
          padding: EdgeInsets.symmetric(
              horizontal: screenWidth * 0.0467, vertical: screenHeight * 0.017),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              GestureDetector(
                onTap: () {
                  openIndividualOrderScreen(
                      context,
                      trackingID,
                      pickupCity,
                      deliveryCity,
              ...
              GestureDetector(
                onTap: () {
                  openIndividualTrackScreen(context, trackingID, pickupCity,
                      deliveryCity, pickupPin, deliveryPin);
                },
                child: Text(
                  'Track Orders',
                  style: TextStyle(
...
openIndividualOrderScreen(context, trackingID, pickupCity, deliveryCity,
    pickupPin, deliveryPin, orderValue, applicableWeight, deliveryStatus) {
  Navigator.push(
    context,
    MaterialPageRoute(
